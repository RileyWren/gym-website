...
<div className="grid w-full justify-center gap-4 px-4 grid-cols-[repeat(auto-fit,_minmax(300px,_1fr))]">
  <img src={gym1} className="w-full h-[400px] object-cover rounded-lg" />
  <img src={gym2} className="w-full h-[400px] object-cover rounded-lg" />
  <img src={gym3} className="w-full h-[400px] object-cover rounded-lg" />
  <img src={gym4} className="w-full h-[400px] object-cover rounded-lg" />
</div>
